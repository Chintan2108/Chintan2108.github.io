...
.dropdown-menu li a:hover {
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3 col-lg-4 col-lg-offset-4">                    
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" method="POST" action="validate.php">
                            ...
                            <div class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <center>
                                        <input type="submit" name="login" value="Login" min="1" class="btn btn-success" style="background-color: #212F3C;color: #85C1E9;width: 160px">
                                      <!--<input id="btn-login" type="submit" value="Login" class="btn btn-success" style="background-color: #212F3C;color: #85C1E9;width: 160px" />--></center>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 control">
                                        <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
  											Login as an
                                        <a href="login_admin.php" onClick="$('#loginbox').hide(); $('#signupbox').show()">
     												Administrator
                                        </a>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 control">
                                        ...
                                        <a href="registration_form.php" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                            Sign Up Here
                                        </a>
                                        </div>
                                    </div>
